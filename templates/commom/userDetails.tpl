...
{fbvFormArea id="userDetails"} 
	xxx{fbvFormSection title="user.name"}
...
yyyy	{fbvFormSection for="preferredPublicName" description="user.preferredPublicName.description"}
...
zzzz	{if !$disableUserNameSection}
